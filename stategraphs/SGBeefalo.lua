...
local states=
{
        ...
        timeline=
        {
            TimeEvent(14*FRAMES, function(inst)
                ...
                if loot.components.moisturelistener then
                    loot.components.moisturelistener:SetMoisture(50)
                end
            end),
        },
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(28*FRAMES, function(inst) SpawnPrefab("beefalo_transform_fx").Transform:SetPosition(inst.Transform:GetWorldPosition()) end),
            TimeEvent(31*FRAMES, function(inst) inst:UpdateDomestication() end),
        },
